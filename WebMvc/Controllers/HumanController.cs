...
using FormsAndBindings.Data;
using FormsAndBindings.Models;

namespace FormsAndBindings.Controllers
{
    public class HumanController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address,DateOfBirth,FavoriteNumber,IsActive")] Human human)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Address,DateOfBirth,FavoriteNumber,IsActive")] Human human)
        {
            if (id != human.Id)
            {
                return NotFound();
